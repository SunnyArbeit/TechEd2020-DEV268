CLASS zcl_generate_dev268_9999 DEFINITION
 PUBLIC
  ...
  PRIVATE SECTION.
    ...
    DATA package_name  TYPE sxco_package VALUE  'ZRAP_INVENTORY_9999'.
    DATA unique_number TYPE string VALUE '9999'.
...
CLASS zcl_generate_dev268_9999 IMPLEMENTATION.
  METHOD main.
