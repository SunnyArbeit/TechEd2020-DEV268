@EndUserText.label: 'TechEd2020-DEV268:Custom entity for products from ES5'
@ObjectModel.query.implementedBy: 'ABAP:ZCL_CE_RAP_PRODUCTS_9999'
define custom entity ZCE_RAP_PRODUCTS_9999
{
